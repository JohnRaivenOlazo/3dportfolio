  ...
  return (
      <div className="text-white">
        ...
        <p className="text-gray-400 mb-10 text-sm">
          I actively use this wide range of tools, and I continue to <span className="text-gray-200">explore</span> new ones. I love working with these technologies and am always <span className="text-gray-200">eager</span> to learn.
        </p>
        <div ref={ref} className="grid grid-cols-3 lg:grid-cols-6 justify-items-center gap-4 mx-auto py-4">
