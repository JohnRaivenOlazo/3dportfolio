...
const ContentLeft = ({ activeSection }) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 sm:mt-6 flex items-center gap-3 flex-wrap text-xs sm:text-sm justify-center lg:justify-start cursor-pointer">
      ...
      <div className="mt-10 text-gray-400 hidden lg:block">
      ...
      <div className="mt-5 sm:mt-10 flex gap-5 justify-center lg:justify-start">
